...
import pdb
import imageio
from visualize import visualize_twohands_obj1



parser = argparse.ArgumentParser(description="")
parser.add_argument("--mode", default='obj1', type=str, help='options: obj1, obj2')
parser.add_argument("--input_video_file", default='/mnt/session_space/home/lingzzha/EgoHOS/testvideos/testvideo1_short.mp4', type=str)
parser.add_argument("--output_video_file", default='/mnt/session_space/home/lingzzha/EgoHOS/testvideos/testvideo1_short_result.mp4', type=str)
parser.add_argument("--twohands_config_file", default='/mnt/session_space/home/lingzzha/EgoHOS/mmsegmentation/work_dirs/seg_twohands_ccda/seg_twohands_ccda.py', type=str)
parser.add_argument("--twohands_checkpoint_file", default='/mnt/session_space/home/lingzzha/EgoHOS/mmsegmentation/work_dirs/seg_twohands_ccda/best_mIoU_iter_56000.pth', type=str)
parser.add_argument("--cb_config_file", default='/mnt/session_space/home/lingzzha/EgoHOS/mmsegmentation/work_dirs/twohands_to_cb_ccda/twohands_to_cb_ccda.py', type=str)
parser.add_argument("--cb_checkpoint_file", default='/mnt/session_space/home/lingzzha/EgoHOS/mmsegmentation/work_dirs/twohands_to_cb_ccda/best_mIoU_iter_76000.pth', type=str)
parser.add_argument("--obj1_config_file", default='/mnt/session_space/home/lingzzha/EgoHOS/mmsegmentation/work_dirs/twohands_cb_to_obj1_ccda/twohands_cb_to_obj1_ccda.py', type=str)
parser.add_argument("--obj1_checkpoint_file", default='/mnt/session_space/home/lingzzha/EgoHOS/mmsegmentation/work_dirs/twohands_cb_to_obj1_ccda/best_mIoU_iter_34000.pth', type=str)
parser.add_argument("--obj2_config_file", default='', type=str)
parser.add_argument("--obj2_checkpoint_file", default='', type=str)
parser.add_argument("--remove_intermediate_images", default=False, type=bool)
args = parser.parse_args()

video_dir = args.input_video_file.split('.')[0]; os.makedirs(video_dir, exist_ok = True)
...
print('stitch prediction into a video for obj1......')
